...
canvas.style.background = "Pink"; // Establece el color de fondo del lienzo
...
update(context, circles) {
    ...
    this.color = touching ? "white" : "black";
}
...
for (let i = 0; i < numCircles; i++) {
    ...
    let circle = new Circle(randomX, randomY, randomRadius, "black", (i + 1).toString(), 2);
    circles.push(circle);
}
